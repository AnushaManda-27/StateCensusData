...
class IndianStatesInfo(Exception):
...
if __name__ == '__main__':
    ...
    print(header)
    rec = IndianStatesInfo.records(info)
    print(rec)
   
    
    typedata = IndianStatesInfo.type_mismatch(file_name) 
    print(typedata)
    
    head = IndianStatesInfo.header_check(header)
    print(head)
